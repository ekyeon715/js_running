...
let arr8 = student.sort((a, b) => a.age-b.age).reverse();
console.log(arr8);
...
let arr12 = arr.some(n => n < 0);
console.log(arr12);

12.
var arr = [1, 5, -3, 10, 0, 8];
// 모든 숫자가 음수인지 판별하는 코드를 작성하고 반환값을 출력해주세요
let arr13 = arr.every(n => n < 0);
console.log(arr13);